...
print('Halo, perkenalkan nama saya adalah ' + nama + 
      '\nsaya biasa dipanggil ' + nama_panggilan + ' dengan NIM ' + str(nim) + 
      '\numur saya adalah ' + str(umur) + ' dan tinggi saya adalah ' + str(tinggi) + 
      '\ntotal NIM terakhir saya saat dimoduluskan dengan 6 adalah ' + str(r))